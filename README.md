...
Задания нужно сдавать в [anytask](https://anytask.org) (ссылка появится позже). Инвайт: появится позже. Для доступа к курсу необходимо зарегистрироваться в системе.
...
* [Практическое задание 1](https://github.com/nadiinchi/iad2019/blob/master/materials/hw_sem1.ipynb). Мягкий дедлайн: 4 февраля, 23:59. Жесткий дедлайн: 11 февраля, 23:59.
